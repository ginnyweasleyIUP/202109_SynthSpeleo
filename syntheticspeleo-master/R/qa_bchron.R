...
quanAna_bchron <- function(p.min = 0.1, p.max=1,p.n=5,t.min=0,t.max=10000,t.n=4,d.min=0,d.max=1000,h.length=c(2000,3000,500),file_path1 ='~/synSpeleo/test/', file_path2 = '~/synSpeleo/test/summary' ,rate=3,t.res=2, nsamp=15,n=2){
...
synSpeleo_chrono_bchron <- quanAna_bchron(file_path1 = '/stacycode/ariana/synSpeleo/AM',file_path2='/stacycode/ariana/synSpeleo/summary/', p.min=0.1,p.max=300,p.n=5, n=10,h.length=c(1000,2000,500))

save(synSpeleo_chrono_bchron, file = '/stacycode/ariana/synSpeleo/summary/synSpeleo_chrono_bchron.RData')
