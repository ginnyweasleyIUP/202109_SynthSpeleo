...
synSpeleo_chrono_AM_1 <- quanAna_AM(file_path1 = '/stacycode/ariana/synSpeleo/AM',file_path2='/stacycode/ariana/synSpeleo/summary/', precision = c(10,50,100,200,300,500), n=100,h.length=c(1000,2000,500), k = 1)

save(synSpeleo_chrono_AM_1, file = '/stacycode/ariana/synSpeleo/summary/synSpeleo_chrono_AM_1.RData')
