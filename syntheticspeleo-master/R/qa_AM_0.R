...
synSpeleo_chrono_AM_0 <- quanAna_AM(file_path1 = '/stacycode/ariana/synSpeleo/AM',file_path2='/stacycode/ariana/synSpeleo/summary/', precision = c(10,50,100,200,300,500), n=100,h.length=c(1000,2000,500), k = 0)

save(synSpeleo_chrono_AM_0, file = '/stacycode/ariana/synSpeleo/summary/synSpeleo_chrono_AM_0.RData')
