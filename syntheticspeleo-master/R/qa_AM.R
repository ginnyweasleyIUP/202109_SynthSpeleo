...
quanAna_AM <- function(p.min = 0.1, p.max,p.n,t.min=0,t.max=10000,t.n=4,d.min=0,d.max=1000,h.length,file_path1, file_path2 ,rate=3,t.res=2, nsamp=15,n){
...
synSpeleo_chrono_AM <- quanAna_AM(file_path1 = '/stacycode/ariana/synSpeleo/AM',file_path2='/stacycode/ariana/synSpeleo/summary/', p.min=0.1,p.max=300,p.n=7, n=100,h.length=c(1000,2000,500))

save(synSpeleo_chrono_AM, file = '/stacycode/ariana/synSpeleo/summary/synSpeleo_chrono_AM.RData')
